# 4. Utilize uma lista para resolver o problema a seguir. Uma empresa paga seus vendedores com base
# em comissões. O vendedor recebe $200 por semana mais 9% de suas vendas brutas
